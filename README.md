...
Give your OpenClaw agent 40 tools for live structured web data: search, product research, travel, media, markets, finance, SEC filings, and company hiring.
...
The 28 platform packages can run together, registering 40 distinct tools. Disable the overlapping starter first with `openclaw plugins disable crawlora`. The platform packages refuse registration while the starter's config entry is enabled, preventing duplicate tool registrations. Do not re-enable both at once.
...
The capability flag approves registration of the 40 tools listed below. Review the tool list and data-handling section before installing.
