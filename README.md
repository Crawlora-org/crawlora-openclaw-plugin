...
Give your OpenClaw agent 123 tools for live structured web data: search, product research, travel, media, markets, finance, SEC filings, and company hiring.
...
| `@crawlora-org/bing` | Web search (1) | [Bing](packages/bing/README.md) |
| `@crawlora-org/ebay` | Marketplace listing search (1) | [eBay](packages/ebay/README.md) |
| `@crawlora-org/yahoo-finance` | Ticker quotes (1) | [Yahoo Finance](packages/yahoo-finance/README.md) |
| `@crawlora-org/greenhouse` | Public job boards (1) | [Greenhouse](packages/greenhouse/README.md) |
| `@crawlora-org/lever` | Public job postings (1) | [Lever](packages/lever/README.md) |
| `@crawlora-org/ashby` | Public job boards (1) | [Ashby](packages/ashby/README.md) |
| `@crawlora-org/jobs` | ATS discovery and hiring signals (2) | [Jobs](packages/jobs/README.md) |
| `@crawlora-org/spotify` | Music and podcast search (1) | [Spotify](packages/spotify/README.md) |
| `@crawlora-org/tiktok` | Public post data (1) | [TikTok](packages/tiktok/README.md) |
| `@crawlora-org/reddit` | Public post search (1) | [Reddit](packages/reddit/README.md) |
| `@crawlora-org/github` | Repository search (1) | [GitHub](packages/github/README.md) |
| `@crawlora-org/pinterest` | Public pin search (1) | [Pinterest](packages/pinterest/README.md) |
| `@crawlora-org/airbnb` | Listing search (1) | [Airbnb](packages/airbnb/README.md) |
| `@crawlora-org/booking` | Accommodation search (1) | [Booking.com](packages/booking/README.md) |
| `@crawlora-org/yelp` | Business search (1) | [Yelp](packages/yelp/README.md) |
| `@crawlora-org/zillow` | Property search (1) | [Zillow](packages/zillow/README.md) |
| `@crawlora-org/imdb` | Title search (1) | [IMDb](packages/imdb/README.md) |
| `@crawlora-org/steam` | App details (1) | [Steam](packages/steam/README.md) |
| `@crawlora-org/coingecko` | Cryptocurrency markets (1) | [CoinGecko](packages/coingecko/README.md) |
| `@crawlora-org/polymarket` | Prediction events (1) | [Polymarket](packages/polymarket/README.md) |
| `@crawlora-org/kalshi` | Prediction events (1) | [Kalshi](packages/kalshi/README.md) |
| `@crawlora-org/apple-books` | Book catalog search (1) | [Apple Books](packages/apple-books/README.md) |
| `@crawlora-org/apple-jobs` | Job search (1) | [Apple Jobs](packages/apple-jobs/README.md) |
| `@crawlora-org/opensea` | NFT collection data (1) | [OpenSea](packages/opensea/README.md) |

```sh
openclaw plugins install clawhub:@crawlora-org/amazon --accept-capabilities
```

The 111 platform packages can run together, registering 123 distinct tools. The catalog includes focused adapters for major public families and is generated from the published Crawlora SDK operation metadata. Disable the overlapping starter first with `openclaw plugins disable crawlora`. The platform packages refuse registration while the starter's config entry is enabled, preventing duplicate tool registrations. Do not re-enable both at once.
...
The capability flag approves registration of the 23 starter tools listed below. Focused platform packages expose the rest of the catalog through their own capability prompts. Review the tool list and data-handling section before installing.
...
Substitute another slug from the platform table as needed. Track each attempt ID and artifact digest in `notes/releases/`. A pending upload is not a published release; inspect the existing attempt before retrying an uncertain upload.
