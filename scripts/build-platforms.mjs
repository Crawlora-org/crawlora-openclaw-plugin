...
for(const platform of platforms){
 ...
 const renderedTools=tools.map(name=>{
  ...
  return `tool({name:${JSON.stringify(name)},description:${JSON.stringify(spec.description)},parameters:Type.Object({${properties}}),async execute(params,config,context){return callCrawlora(config,context.signal,${JSON.stringify(spec.operation)},params);}})`;
 }).join(',\n');
